...
let div = d3.select("#graphic").append("div")
    .attr("class", "tooltip")
    .style("opacity", 0)
    .style("background", "#262B28")
    .style("padding", "0px")
...
d3.csv("https://raw.githubusercontent.com/aadittambe/thanksgiving-travel/main/tsa.csv",
    ...
    function (d) {
        return { date: d3.timeParse("%-b. %-d")(d.formatted_date), throughput22: d["2022-throughput"], throughput21: d["2021-throughput"], throughput20: d["2020-throughput"] }
    }).then(
